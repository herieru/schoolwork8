...
/**
 * Created by akihiro on 2016/02/22.
 */
public class Monster extends Obj{
    ...
    public Monster()
    {
        ...
        w = new GLWorld();
        w._scale.Init(0.2f,0.2f,0.2f);
        w._pos.Init(0,0.0f,0);
        objtype = OBJTYPE.MONTER;
    ...
    public void Draw(GL10 gl) {
        if(model != null && IsLife) {
            ...
            model.Draw(gl, ModelManage.MONSTER);
            gl.glPopMatrix();
        }
    }
